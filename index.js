const namesAndHex = [
  ...
  // gets random array and assigns color name and hex to appropriate variables
  function changeStuff (name, hex, swatch) {
    ...
    // assigns hex value displayed as text
    let hexValueMain = document.getElementById(hex);
    hexValueMain.innerHTML = hexColor;
    
    // assigns same hex value that's displayed as text to fill the bgcolor of the swatch div
  ...
  //changes all swatches by running above function 3 times
